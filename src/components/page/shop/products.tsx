  ...
  return (
    <>
      {products && products.loading ? (
        <div className="fixed top-0 left-0 h-screen w-full z-[2500] bg-black/60">
          <div
            role="status"
          ...
          >
            <svg
              aria-hidden="true"
              className=" w-20 h-20 text-white animate-spin  fill-red-600"
              viewBox="0 0 100 101"
              fill="none"
      ...
      <Container styles="py-8">
        <Stack direction="flex-col" gap="gap-12">
          {!products.data.length && !products.loading ? (
