...
export const Hero = () => {
  return (
    <div className="w-full pt-48 md:pt-72 pb-16 md:pb-24 bg-[url('/images/bg_img.png')] bg-red-600 relative">
      ...
      <Container styles=" xl:pt-0 xl:flex flex-wrap w-full h-full relative">
        <div className="content basis-full xl:basis-2/4 pr-0 xl:pr-8">
          ...
          <p className="text-md md:text-xl text-slate-50 mt-4 mb-16">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
